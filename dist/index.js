...
/* harmony import */ var _history_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(911);
...
/* harmony import */ var _lazyLoading_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(497);
/* harmony import */ var _filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(829);
                    ...
                    const updateOrder = function (rows) {
                        ...
                        if (obj.results && obj.results.length) {
                            if (obj.searchInput.value) {
                                ...
                                _filter_js__WEBPACK_IMPORTED_MODULE_4__/* .closeFilter */.F8.call(obj);
                            }
                        } else {
                            // Create page
                            obj.results = null;
                            ...
                            if (obj.options.pagination > 0) {
                                ...
                                _lazyLoading_js__WEBPACK_IMPORTED_MODULE_3__/* .loadPage */.wu.call(obj, 0);
                            } else {
                    ...
                    const orderBy = function (column, order) {
                        ...
                        if (column >= 0) {
                            ...
                            // Save history
                            _history_js__WEBPACK_IMPORTED_MODULE_0__/* .setHistory */.Dh.call(obj, {
                                action: 'orderBy',
                                rows: newValue,
                                column: column,
                                order: order,
                            ...
                            // On sort event
                            _dispatch_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */.A.call(obj, 'onsort', obj, column, order, newValue.map((row) => row));
...
/* harmony import */ var _selection_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(657);
                    ...
                    const page = function (pageNumber) {
                        ...
                        // Events
                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onchangepage', obj, pageNumber, oldPage, obj.options.pagination);
                    };
...
/* harmony import */ var _internal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(530);
                    ...
                    const getDefault = function () {
                        ...
                        const getActive = function () {
                            return _internal_js__WEBPACK_IMPORTED_MODULE_1__/* .getWorksheetInstance */.eN.call(spreadsheet);
                        };
                        ...
                        items.push({
                            ...
                            onclick: function () {
                                ...
                                if (worksheet.selectedCell && confirm(jSuites.translate('The merged cells will retain the value of the top-left cell only. Are you sure?'))) {
                                    ...
                                    let cell = (0, _helpers_js__WEBPACK_IMPORTED_MODULE_0__.getCellNameFromCoords)(selectedRange[0], selectedRange[1]);
                                    ...
                                    if (selectedRange) {
                                        ...
                                        for (let j = selectedRange[1]; j <= selectedRange[3]; j++) { // Row - py - uy
                                            for (let i = selectedRange[0]; i <= selectedRange[2]; i++) { // Col - px - ux
                                                setBorder((0, _helpers_js__WEBPACK_IMPORTED_MODULE_0__.getCellNameFromCoords)(i, j), i, j);

                                                if (worksheet.records[j][i].element.getAttribute('data-merged')) {
                                                    setBorder(
                                                        (0, _helpers_js__WEBPACK_IMPORTED_MODULE_0__.getCellNameFromCoords)(
                                                            selectedRange[0],
                                                            selectedRange[1],
                                                        ),
                                                        i,
                                ...
                                if (items[i].options) {
                                    ...
                                    if (items[i].k && !items[i].onchange) {
                                        items[i].onchange = function (el, config, value) {
                                            const worksheet = _internal_js__WEBPACK_IMPORTED_MODULE_1__/* .getWorksheetInstance */.eN.call(spreadsheet);
...
/* harmony import */ var _dispatch_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(805);
/* harmony import */ var _selection_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(657);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(978);
/* harmony import */ var _meta_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(654);
/* harmony import */ var _freeze_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(296);
/* harmony import */ var _pagination_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(167);
/* harmony import */ var _footer_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(160);
/* harmony import */ var _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(689);
                    ...
                    const updateTable = function () {
                        ...
                        // Update footers
                        if (obj.options.footers) {
                            _footer_js__WEBPACK_IMPORTED_MODULE_6__/* .setFooter */.e.call(obj);
                        }
                    ...
                    const executeFormula = function (expression, x, y) {
                        ...
                        const execute = function (expression, x, y) {
                            ...
                            const parentId = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getColumnNameFromId */.t3)([x, y]);
                            ...
                            const tokensUpdate = function (tokens) {
                                for (let index = 0; index < tokens.length; index++) {
                                    ...
                                    const e1 = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(token[0], true);
                                    const e2 = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(token[1], true);
                                    ...
                                    for (let j = y1; j <= y2; j++) {
                                        for (let i = x1; i <= x2; i++) {
                                            f.push((0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getColumnNameFromId */.t3)([i, j]));
                                        }
                                    }
                            ...
                            if (tokens && tokens.indexOf(parentId) > -1) {
                                ...
                                if (tokens) {
                                    for (let i = 0; i < tokens.length; i++) {
                                        ...
                                        if (eval('typeof(' + tokens[i] + ') == "undefined"')) {
                                            // Coords
                                            const position = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(tokens[i], 1);
                                            // Get value
                                            let value;
                                ...
                                const ret = _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onbeforeformula', obj, expression, x, y);
                                if (ret === false) {
                                    return expression;
                                } else if (ret) {
                                    expression = ret;
                    ...
                    const createCell = function (i, j, value) {
                        ...
                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'oncreatecell', obj, td, i, j, value);
                    ...
                    const updateCell = function (x, y, value, force) {
                        ...
                        if (obj.records[y][x].element.classList.contains('readonly') == true && !force) {
                            ...
                            // On change
                            const val = _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onbeforechange', obj, obj.records[y][x].element, x, y, value);
                    ...
                    const updateFormulaChain = function (x, y, records) {
                        ...
                        const cellId = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getColumnNameFromId */.t3)([x, y]);
                        if (obj.formula[cellId] && obj.formula[cellId].length > 0) {
                            if (chainLoopProtection[cellId]) {
                                ...
                                for (let i = 0; i < obj.formula[cellId].length; i++) {
                                    const cell = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(obj.formula[cellId][i], true);
                                    // Update cell
                    ...
                    const updateTableReferences = function () {
                        ...
                        for (let i = 0; i < obj.headers.length; i++) {
                            ...
                            if (x != i) {
                                ...
                                if (!obj.headers[i].getAttribute('title')) {
                                    obj.headers[i].innerHTML = (0, _helpers_js__WEBPACK_IMPORTED_MODULE_2__.getColumnName)(i);
                                }
                            }
                        }
                        ...
                        const updatePosition = function (x, y, i, j) {
                            ...
                            // Other updates
                            if (x != i || y != j) {
                                const columnIdFrom = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getColumnNameFromId */.t3)([x, y]);
                                const columnIdTo = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getColumnNameFromId */.t3)([i, j]);
                        ...
                        if (keys.length) {
                            for (let i = 0; i < keys.length; i++) {
                                if (mergeCellUpdates[keys[i]]) {
                                    const info = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(keys[i], true);
                                    let x = info[0];
                                    let y = info[1];
                        ...
                        // Update meta data
                        _meta_js__WEBPACK_IMPORTED_MODULE_3__/* .updateMeta */.hs.call(obj, affectedTokens);
                    ...
                    const updateScroll = function (direction) {
                        ...
                        // Freeze columns?
                        const freezed = _freeze_js__WEBPACK_IMPORTED_MODULE_4__/* .getFreezeWidth */.w.call(obj);
                    ...
                    const updateResult = function () {
                        ...
                        // Update pagination
                        if (obj.options.pagination > 0) {
                            _pagination_js__WEBPACK_IMPORTED_MODULE_5__/* .updatePagination */.IV.call(obj);
                        }
                    ...
                    const getCell = function (x, y) {
                        ...
                        if (typeof x === 'string') {
                            ...
                            const cell = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_7__/* .getIdFromColumnName */.vu)(x, true);
...
/* harmony import */ var _dispatch_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(805);
/* harmony import */ var _freeze_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(296);
/* harmony import */ var _helpers_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(978);
...
/* harmony import */ var _internalHelpers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(689);
/* harmony import */ var _toolbar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(392);
                    ...
                    const updateCornerPosition = function () {
                        ...
                        if (!obj.highlighted || !obj.highlighted.length) {
                            ...
                            if (obj.options.freezeColumns) {
                                const width = _freeze_js__WEBPACK_IMPORTED_MODULE_1__/* .getFreezeWidth */.w.call(obj);
                        ...
                        (0, _toolbar_js__WEBPACK_IMPORTED_MODULE_6__/* .updateToolbar */.nK)(obj);
                    };
                    ...
                    const resetSelection = function (blur) {
                        ...
                        if (blur == true && previousStatus == 1) {
                            _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onblur', obj);
                        }
                    ...
                    const updateSelectionFromCoords = function (x1, y1, x2, y2, origin) {
                        ...
                        const ret = _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onbeforeselection', obj, borderLeft, borderTop, borderRight, borderBottom, origin);
                        if (ret === false) {
                            return false;
                        }
                        ...
                        // Handle events
                        if (previousState == 0) {
                            _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onfocus', obj);

                            removeCopyingSelection();
                        }

                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onselection', obj, borderLeft, borderTop, borderRight, borderBottom, origin);
                    ...
                    const copyData = function (o, d) {
                        ...
                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onafterchanges', obj, onafterchangesRecords);
                    };
                    ...
                    const getSelected = function (columnNameOnly) {
                        ...
                        for (let y = selectedRange[1]; y <= selectedRange[3]; y++) {
                            for (let x = selectedRange[0]; x <= selectedRange[2]; x++) {
                                if (columnNameOnly) {
                                    cells.push((0, _helpers_js__WEBPACK_IMPORTED_MODULE_2__.getCellNameFromCoords)(x, y));
                                } else {
                    ...
                    const getRange = function () {
                        ...
                        const start = (0, _helpers_js__WEBPACK_IMPORTED_MODULE_2__.getCellNameFromCoords)(selectedRange[0], selectedRange[1]);
                        const end = (0, _helpers_js__WEBPACK_IMPORTED_MODULE_2__.getCellNameFromCoords)(selectedRange[2], selectedRange[3]);
...
/* harmony import */ var _selection_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(657);
                    ...
                    const closeFilter = function (columnId) {
                        ...
                        _internal_js__WEBPACK_IMPORTED_MODULE_0__/* .updateResult */.hG.call(obj);
                    };
...
/* harmony import */ var _internal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(530);
/* harmony import */ var _history_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(911);
/* harmony import */ var _dispatch_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(805);
/* harmony import */ var _selection_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(657);
                    ...
                    const setMerge = function (cellName, colspan, rowspan, ignoreHistoryAndEvents) {
                        ...
                        if (test) {
                            ...
                            _selection_js__WEBPACK_IMPORTED_MODULE_4__/* .updateSelection */.c6.call(obj, obj.records[cell[1]][cell[0]].element);

                            if (!ignoreHistoryAndEvents) {
                                _history_js__WEBPACK_IMPORTED_MODULE_2__/* .setHistory */.Dh.call(obj, {
                                    action: 'setMerge',
                                    column: cellName,
                                    colspan: colspan,
                                    rowspan: rowspan,
                                ...
                                _dispatch_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */.A.call(obj, 'onmerge', obj, { [cellName]: [colspan, rowspan] });
                            }
                        }
                    };
                    ...
                    const removeMerge = function (cellName, data, keepOptions) {
                        ...
                        if (obj.options.mergeCells && obj.options.mergeCells[cellName]) {
                            ...
                            // Update selection
                            _selection_js__WEBPACK_IMPORTED_MODULE_4__/* .updateSelection */.c6.call(obj, obj.records[cell[1]][cell[0]].element, obj.records[cell[1] + j - 1][cell[0] + i - 1].element);
...
/* harmony import */ var _internal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(530);
/* harmony import */ var _merges_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(910);
/* harmony import */ var _orderBy_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(94);
/* harmony import */ var _selection_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(657);
                    ...
                    const historyProcessRow = function (type, historyRecord) {
                        ...
                        if (type == 1) {
                            ...
                            _selection_js__WEBPACK_IMPORTED_MODULE_5__/* .conditionalSelectionUpdate */.at.call(obj, 1, rowIndex, (numOfRows + rowIndex) - 1);
                        } else {
                            // Insert data
                            const records = historyRecord.rowRecords.map((row) => {
                                return [...row];
                            });
                            obj.records = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_1__/* .injectArray */.Hh)(obj.records, rowIndex, records);

                            const data = historyRecord.rowData.map((row) => {
                                return [...row];
                            });
                            obj.options.data = (0, _internalHelpers_js__WEBPACK_IMPORTED_MODULE_1__/* .injectArray */.Hh)(obj.options.data, rowIndex, data);
                    ...
                    const undo = function () {
                        ...
                        if (obj.historyIndex >= 0) {
                            ...
                            if (historyRecord.action == 'insertRow') {
                                ...
                                _orderBy_js__WEBPACK_IMPORTED_MODULE_4__/* .updateOrderArrow */.Th.call(obj, historyRecord.column, historyRecord.order ? 0 : 1);
                                _orderBy_js__WEBPACK_IMPORTED_MODULE_4__/* .updateOrder */.iY.call(obj, rows);
                        ...
                        // Events
                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onundo', obj, historyRecord);
                    };
                    ...
                    const redo = function () {
                        ...
                        if (obj.historyIndex < obj.history.length - 1) {
                            ...
                            if (historyRecord.action == 'insertRow') {
                                ...
                                _merges_js__WEBPACK_IMPORTED_MODULE_3__/* .setMerge */.FU.call(obj, historyRecord.column, historyRecord.colspan, historyRecord.rowspan, 1);
                            } else if (historyRecord.action == 'setStyle') {
                                ...
                                _orderBy_js__WEBPACK_IMPORTED_MODULE_4__/* .updateOrderArrow */.Th.call(obj, historyRecord.column, historyRecord.order);
                                _orderBy_js__WEBPACK_IMPORTED_MODULE_4__/* .updateOrder */.iY.call(obj, historyRecord.rows);
                            } else if (historyRecord.action == 'setValue') {
                        ...
                        // Events
                        _dispatch_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.A.call(obj, 'onredo', obj, historyRecord);
                    };
            ...
            if (x != null && y != null && data) {
                ...
                while (row = data[j]) {
                    ...
                    while (row[i] != null) {
                        ...
                        const record = internal/* updateCell */.k9.call(obj, colIndex, rowIndex, value);
                        // Keep history
                        records.push(record);
                        // Update all formulas in the chain
